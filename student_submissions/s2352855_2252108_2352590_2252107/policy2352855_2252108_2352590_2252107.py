...
class Policy2352855_2252108_2352590_2252107(Policy):
                ...
                for i, stock in enumerate(observation["stocks"]):
                    ...
                    if stock_w >= prod_w and stock_h >= prod_h:
                        ...
                        if leftover_area < min_leftover_area:
                            pos_x, pos_y = self._find_position_(
                                stock, prod_size)
                ...
                for i, stock in enumerate(observation["stocks"]):
                    ...
                    if pos_x is not None and pos_y is not None:
                        ...
                        usable_area_ratio = max(
                            leftover_w, 0) * max(leftover_h, 0) / (stock_w * stock_h)
                        # Combine waste and usability
                        placement_score = waste + (1 - usable_area_ratio)
